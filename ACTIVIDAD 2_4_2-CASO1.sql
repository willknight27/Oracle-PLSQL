...
BEGIN
    ...
    FOR R_SOCIOS IN C_SOCIOS LOOP
        ...
        --USUARIO_CLAVE*****************************************************
        R_USUARIO_CLAVE.CLAVE_USUARIO := UPPER(SUBSTR(R_SOCIOS.APPATERNO,-3,3))||(EXTRACT(YEAR FROM R_SOCIOS.FECHA_NACIMIENTO)*2)||
                                        (R_SOCIOS.NRO_SOCIO*3)||TO_CHAR(SYSDATE,'MMYYYY')||'*';
